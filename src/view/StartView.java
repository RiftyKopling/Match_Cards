...
public class StartView extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        model.HistoryDAO dao = new model.HistoryDAO();

        // Cek apakah database kosong (ukuran list 0)
        if (dao.getAllHistory().isEmpty()) {
            // Jika kosong, tampilkan peringatan dan jangan buka History
            javax.swing.JOptionPane.showMessageDialog(this, "History masih kosong! Silakan mainkan game terlebih dahulu.", "Info", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        } else {
            // Jika ada isinya, buka window History
